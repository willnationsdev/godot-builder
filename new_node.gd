...
const ICON_ADD: Texture = preload("res://addons/godot-builder/icons/icon_add.svg")
const ICON_DELETE: Texture = preload("res://addons/godot-builder/icons/icon_import_fail.svg")
